...
| REQ-F-125 | 🟡 | archive | List archived prompts |
| REQ-F-126 | 🟡 | archive | Restore archived prompt |
| REQ-F-127 | 🟡 | archive | Purge archived prompt |
| REQ-F-128 | 🟡 | tag | Add a tag |
| REQ-F-129 | 🟡 | tag | Remove a tag |
| REQ-F-130 | 🟡 | tag | List tags for a prompt |
| REQ-F-131 | 🔴 | reindex | Rebuild index from metadata |
| REQ-F-132 | 🟡 | reindex | Reindex dry-run |
| REQ-F-133 | 🟢 | stats | Display library statistics |
